...
func init() {
	m.Register(func(app core.App) error {
		collection, err := findOrCreateCollection(app, "source_product_jobs")
		if err != nil {
			return err
		}
		...
		collection.Fields.Add(
			...
			&core.JSONField{Name: "failed_items_json"},
			&core.JSONField{Name: "product_ids_json"},
		)

		collection.AddIndex("idx_source_product_jobs_type", false, "job_type, status", "")
		return app.Save(collection)
	}, func(app core.App) error {
		return deleteCollectionIfExists(app, "source_product_jobs")
	})
}
